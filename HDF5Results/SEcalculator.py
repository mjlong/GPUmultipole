...
def BnpMoment(n,p,m):
    ...
    if(3==m):
        n (-1 + P) P (-1 + 2 P)
    if(4==m):
        n (-1 + P) P (-1 + 3 (-2 + n) (-1 + P) P)
    if(5==m):
        -n (-1 + P) P (-1 + 2 P) (-1 + 2 (-6 + 5 n) (-1 + P) P)
    if(6==m):
        -n (-1 + P) P (1 + 5 (-1 + P) P (6 (1 - 2 P)^2 + 3 n^2 (-1 + P) P +  n (-5 - 26 (-1 + P) P)))
    if(7==m):
        n (-1 + P) P (-1 + 2 P) (1 + (-1 + P) P (105 n^2 (-1 + P) P + 60 (1 + 6 (-1 + P) P) - 14 n (4 + 33 (-1 + P) P)))
