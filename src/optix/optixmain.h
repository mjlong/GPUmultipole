...
#if defined(__QUICKW)
void initialize_context(RTcontext, int,unsigned, int, int, float*, MemStruct,multipole, material, CComplex<double>*);
void createContext( int width,unsigned devstep, float R1, float Hh, unsigned num_geo, RTcontext context, MemStruct DeviceMem,multipole,material, CComplex<double>*);
#else
