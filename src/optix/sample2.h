...
void createContext( int width, float R1, float Hh,unsigned int num, RTcontext* context, RTbuffer* buffer, RTbuffer*, RTbuffer*, float*, long long unsigned int);
...
void tracemain(int, int, int, float*, long long unsigned int);
